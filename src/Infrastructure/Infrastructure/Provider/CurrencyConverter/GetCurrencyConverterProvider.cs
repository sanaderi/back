namespace GamaEdtech.Infrastructure.Provider.CurrencyConverter
{
    ...
    public sealed class GetCurrencyConverterProvider(Lazy<IHttpProvider> httpProvider, Lazy<IStringLocalizer<GetCurrencyConverterProvider>> localizer, Lazy<ILogger<GetCurrencyConverterProvider>> logger
        , Lazy<IConfiguration> configuration)
        : InfrastructureBase<GetCurrencyConverterProvider>(httpProvider, localizer, logger), ICurrencyConverterProvider
    {
        public Currency ProviderType => Currency.GET;

namespace GamaEdtech.Infrastructure.Provider.CurrencyConverter
{
    ...
    public sealed class UsdcCurrencyConverterProvider(Lazy<IHttpProvider> httpProvider, Lazy<IStringLocalizer<UsdcCurrencyConverterProvider>> localizer, Lazy<ILogger<UsdcCurrencyConverterProvider>> logger)
        : InfrastructureBase<UsdcCurrencyConverterProvider>(httpProvider, localizer, logger), ICurrencyConverterProvider
    {
        public Currency ProviderType => Currency.USDC;
